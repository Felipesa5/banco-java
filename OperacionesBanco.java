...
public class OperacionesBanco {
    ...
    public void menuOpciones(){
        ...
        JOptionPane.showMessageDialog(null, "Bienvenido al Banco Sanchez que deseas hacer hoy?");
    ...
    private void menu(int num){
        switch (num) {
            ...
            boolean seAgrego = banco.adiccionarCuenta(numCuentasString, saldoInicial, tipoCuenta, cedulaTitular, nombreTitular);
            if (seAgrego) {
                ...
                case 5:
                    double totalDineroBanco = banco.totalDinero();
                    JOptionPane.showMessageDialog(null, "El total de dinero del banco es: "+ totalDineroBanco);
                    break;
                case 6:
                    String nombreMayorDinero = banco.clienteMayorDinero();
